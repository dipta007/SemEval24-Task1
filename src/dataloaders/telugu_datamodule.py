...
class TeluguDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self):
        ...
        dataset = pd.read_csv(os.path.join(self.config.data_dir, "tel_train.csv"))
        train_dataset, val_dataset = train_test_split(dataset, test_size=0.1, random_state=self.config.seed)
