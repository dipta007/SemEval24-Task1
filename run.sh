...
sbatch ada.sh python src/train.py --batch_size=16 --enc_pooling="mean" --validate_every=1.0 --accumulate_grad_batches=64 --enc_dropout=0.0 --lr=0.00001 --model_name="sentence-transformers/all-distilroberta-v1" --weight_decay=0.001 --exp_name=v4_best_1

sbatch ada.sh python src/train.py --batch_size=16 --enc_pooling="mean" --validate_every=1.0 --accumulate_grad_batches=32 --enc_dropout=0.1 --lr=0.00001 --model_name="sentence-transformers/all-distilroberta-v1" --weight_decay=0.01 --exp_name=v4_best_2